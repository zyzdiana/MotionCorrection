...
TEST_CASE("an upsampled trilinear interpolator can be created from a volume") {
    typedef float dataT;
    typedef VolumeAtAddressable< std::vector<dataT> > VolumeT; 
    typedef TrilinearInterpolator<VolumeT, float> UpsamplingInterpolatorT;
    typedef UpsampledTrilinearInterpolator<
      UpsamplingInterpolatorT, 4, VolumeT, float >
      InterpolatorT;
    ...
    UpsamplingInterpolatorT upsamplingInterpolator(&volume);
    InterpolatorT interpolator(&volume, &upsamplingInterpolator);
...
TEST_CASE(
  "an upsampled trilinear interpolator can be created from a constant-valued volume") {
    typedef float dataT;
    typedef VolumeAtAddressable< std::vector<dataT> > VolumeT; 
    typedef TrilinearInterpolator<VolumeT, float> UpsamplingInterpolatorT;
    typedef UpsampledTrilinearInterpolator<
